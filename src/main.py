    ...
    for system in system_configs:
        ...
        for bom in system_config.boms:
            ...
            for component_id in component_list:
                ...
                source_obj = nvd_obj if component_id.startswith("cpe:") else osv_obj
                if not component_id.startswith(("cpe:", "pkg:")):
                    continue
                ...
                for vuln in vulns_list:
                    ...
                    # Populate Excel row with primary findings
                    ExcelHelper.populate_template_sheet(
                        new_sheet, data_row, config.TEMPLATE, clean_name, component_id,
            ...
            if row_count > 0:
                epss_manager.query() # Bulk query EPSS for the entire sheet
        ...
        wb.save(f"{save_path}{clean_system_name}{template_ext}")
